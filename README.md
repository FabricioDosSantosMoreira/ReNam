...
ReNam is a handy renaming tool designed for movies, series, and anime, utilizing TMDB.
...
1. **Create a TMDB Account:**
   - Visit [TMDB](https://www.themoviedb.org/) and sign up for an account.

2. **Generate an API Key:**
   - Once logged in, navigate to [TMDB API Settings](https://www.themoviedb.org/settings/api) and generate an API key.

3. **Configure API Key:**
   - Open `ApiHandler.py` and locate the `API_KEY` variable.
   - Replace the existing API key with the one you generated from TMDB.

4. **Run the Application:**
   - Execute `main.py` to launch ReNam.
